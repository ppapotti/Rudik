...
Also, \krd performs consistency with KBs of every size, while other systems cannot scale or fail altogether. % due clearly outperforming state-of-the-art systems . 
We also 
