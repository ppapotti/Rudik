...
\begin{figure}[b]
	\centering
	\vspace{1ex}
	\includegraphics[width=.9\columnwidth,height=2.8cm]{include/figure/vsAmieYago.pdf}
	\vspace{-2ex}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=.9\columnwidth,height=2.8cm]{include/figure/vsAmieDBPedia.pdf}
	\vspace{-1ex}
...
\begin{figure}[b]
	\centering
	\vspace{1ex}
	\includegraphics[width=.9\columnwidth,height=2.5cm]{include/figure/deepDive1K.pdf}
	\vspace{-2ex}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=.9\columnwidth,height=2.5cm]{include/figure/deepDive1M.pdf}
		\vspace{-1ex}
