...
(ii) allow the discovery of {\em approximate} rules to be robust to errors and incompleteness in the KB, 
(iii) use disk-based algorithms, effectively 
%dropping the assumption that the KB has to fit in memory and
%have acceptable performance and 
enabling the mining of large KBs in commodity machines. %, therefore . 
