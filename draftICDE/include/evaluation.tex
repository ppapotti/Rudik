...
\begin{figure}[b]
	...
	\vspace{-2ex}
	\caption{Cumulative accuracy for new facts on \yago, rules executed by descending score.}
...
\begin{figure}[t]
	...
	\vspace{-1ex}
	\caption{Cumulative accuracy for new facts on \dbpedia, rules executed by descending score.}
...
%\vspace{-3ex}
	...
	\begin{small}
		\begin{tabular}{c|c|c|c|c|}
			\cline{2-5}
			& \multicolumn{2}{c|}{\textbf{\amie}} & \multicolumn{2}{c|}{\textbf{\krd} (no literals)} \tabularnewline
			\hline
...
rules that are less general than our approach. On \amie \yago 2, it discovers 2K new facts with a precision lower than 70\%, while the best rule we discover on \yago 2 already produces more than 4K facts with a 100\% precision. 
