...
Full results and explanations%%%%%%%%%JOURNAL on the internal evaluation 
are not reported due to space reasons but 
can be found  at TODO: \url{http://***double-blind***}.
%in the technical report online at \url{http://bit.ly/2bDZO9F}.

\noindent \myparagraph{Machine Learning Application} We prove the applicability of our approach by providing Machine Learning algorithms menaningful training examples.
We use \krd to compute negative examples for distant supervision in \deepdive, showing significantly better results than using only positive examples 
