...
and the output is the same as \amie. We did not compare with classic Inductive Logic Programming systems~\cite{dehaspe1999discovery}, as these are already significantly outperformed by \amie both in accuracy and running time.
...
Full results %%%%%%%%%JOURNAL on the internal evaluation %are not reported due to space reasons but 
