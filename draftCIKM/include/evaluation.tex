...
Full test results 
%%%%JOURNAL%%, including annotated examples and rules, 
...
%\vspace{-2ex}
	...
	\begin{tabular}{|c|c|c|c|c|}
		\hline
		\hline
		{\it KB}&{\it Avg. Run Time}&{\it Avg. Precision All Predicates}&{\it \# Annotations} \tabularnewline
	       & &{\it  (Predicates with Rules)}& \tabularnewline
		\hline
		\dbpedia & 34min, 56sec & \textbf{63.99}\% (\textbf{95.83}\%)& 139\tabularnewline
		\yago 3 &  59min, 25sec & \textbf{62.86}\% (\textbf{96.37}\%)& 150\tabularnewline
		\wikidata &  2h, 21min, 34sec & \textbf{73.33}\% (\textbf{98.13}\%)& 180\tabularnewline
		\hline
	\end{tabular}
	\end{small}
\end{table}
