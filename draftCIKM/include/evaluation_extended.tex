...
\begin{figure}[htb]
	...
	\vspace{-2ex}
	\caption{Accuracy for new facts identified by executing rules according to descending score on  \yago 2 (no literals).}
...
In this technical report we present extended findings of individual components in \krd.
More specifically, we deeply dig on 6 different aspects that characterize our approach.

\noindent \myparagraph{Machine Learning Application}
...
\noindent \myparagraph{LCWA} We study the effect of the LCWA assumption for the generation of negative examples.
