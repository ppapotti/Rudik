package asu.edu.neg_rule_miner.rdf.parser;
...
public class TurtleParser {
	...
	public static void main(String[] args) throws Exception{
		...
		final String fileName = "compressedFreebase";
		final long startLine = 45000000;
		final long endLine = 50000000;
	...
	public void parseRDF(final String fileName, final long startLine,final long endLine) throws IOException{
		...
		while((line = reader.readLine()) != null){
			...
			i++;
			String cleanTriple = cleanTriple(line);
			if(cleanTriple == null){
			...
			InputStream in = IOUtils.toInputStream(cleanTriple, "UTF-8");
			try{
	...
	private String cleanTriple(final String tripleLine){
		...
		String subject = replaceBadCharacter(entities[0]);
		String object;
		String predicate;
