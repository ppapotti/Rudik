...
public class GraphHornRule<T> {
	 ...
	 * @param example2graph
	 */
	public GraphHornRule(Pair<T,T> startingNode,Graph<T> graph){
		this();
	 ...
	 * @return
	 */
	public GraphHornRule<T> duplicateRule(){
		GraphHornRule<T> newRule = new GraphHornRule<T>();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		GraphHornRule<T> other = (GraphHornRule<T>) obj;
		if (rules == null) {
			if (other.rules != null)
				return false;
